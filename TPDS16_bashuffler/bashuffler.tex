...
\begin{abstract}
\red{
The shuffle operation is pervasive in distributed applications and consists of many network flows across computer nodes. \st{in datacenters} 
}
...
We present BAShuffler, a bandwidth-aware shuffle scheduler, that maximizes the overall network bandwidth utilization 
% \st{by using a greedy or a partially greedy method to schedule the source nodes of the shuffle flows} 
...
the original Hadoop, especially in heterogeneous
networks.
\end{abstract}
