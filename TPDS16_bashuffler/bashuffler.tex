...
It will likely lead to much worse performance
...
\item \red{We 
% discussed in detail the difficulty of managing the network bandwidth in 
% current distributed resource management platforms, and 
...
\item \red{We proposed the efficient source selection algorithms, GSS and PGSS,
which maximize the network bandwidth utilization based on the precise 
...
\item \red{We presented BAShuffler, implemented seamlessly in YARN,  
