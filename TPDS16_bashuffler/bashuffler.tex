...
% The paper headers
\markboth{ACM/IEEE Transactions on Networking}%
{}
...
Many tasks are shuffle-heavy, which are communication-intensive.
...
and demonstrate that BAShuffler significantly increases the
shuffle performance. 
...
analyzed and verified~\cite{bertsekas1992data, chiu1989analysis, kelly1998rate, vojnovic2000global}.
...
The solid arrow lines represent remote procedure calls (RPC)
...
\caption{Architecture of BAShuffler and Shuffle-Related Information Maintained in Components}
...
\vspace{-0.5in}
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.5in,clip,keepaspectratio]{author2}}]{Francis C.M. Lau}
