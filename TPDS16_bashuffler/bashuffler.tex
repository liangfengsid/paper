...
\red{
Even in enterprise data centers, heterogeneity exists during the long period of devices upgrading.
}
...
2) The distributed platforms can work on unmodified operation systems and general network devices. 
}
