...
\red{The random source selection policy in shuffle operations 
largely under-utilize the network bandwidth and greatly affect the completion time
of shuffle tasks having large volumes of data to transfer within the cluster,
the shuffle-heavy MapReduce jobs being a typical one. 
}
