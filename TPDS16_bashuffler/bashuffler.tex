...
For example, the physical YARN clusters comprising off-the-shelf
...
The application-level scheduling approach works by making use of both the shuffle-related information (e.g., the arriving patterns and the source/destination pairs of the flows) and the network-level information (e.g., the bandwidth capacity of the network links). 
