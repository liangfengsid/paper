...
and sometimes even dominate the job completion time especially for
...
zaharia2012resilient} have been developed to overcome disk I/O
...
to reuse data across iterations in the memory to avoid the overhead of transferring intermediate data into and out of the disk. 
