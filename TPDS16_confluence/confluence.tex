...
In an iteration, if data generated by previous 
iterations are partitioned to  the node where they will be processed
in the next iteration, unnecessary network traffic can be reduced in the shuffle operation.
